...
.tl-about-h{font-size:clamp(1.6rem, 0.96rem + 2.56vw, 3.2rem);line-height:1.05;letter-spacing:-.03em;font-weight:500;max-width:18ch;margin:16px 0 24px;color:var(--ink)}
...
.tl-about-cta h2{font-size:clamp(19.2px,2.816vw,30.72px);letter-spacing:-.03em;font-weight:500;line-height:1.05;color:#fff;max-width:20ch;margin:0 auto 18px}
